...
<div class="profile-container">
  <div class="cover-image">
    <img src="/pictures/moon.webp" alt="Cover Image">
  </div>
  <div class="profile-image">
    <img src="/pictures/icon2.jpeg" alt="Profile Image">
...
<div class="modal-body"> <img src="" class="img-fluid" />
  ...
  Anything related to technology, internet, Github and programming. 
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function search(query) {
      ...
      xhr.open('GET', '/feed-technology.xml', true);
      xhr.send();
    }
