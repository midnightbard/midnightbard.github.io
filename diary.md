...
<div class="profile-container">
  <div class="cover-image">
    <img src="/pictures/island.webp" alt="Cover Image">
  </div>
  <div class="profile-image">
    <img src="/pictures/icon4.jpeg" alt="Profile Image">
...
<div class="modal-body"> <img src="" class="img-fluid" />
  ...
  Diary is for my hobbies, daily entries, crafts, cooking and movies. 
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function search(query) {
      ...
      xhr.open('GET', '/feed-community.xml', true);
      xhr.send();
    }
